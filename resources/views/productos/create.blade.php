                ...
                <div class="card  box-shadow-0">
                    ...
                    <div class="card-body pt-0">
                        <form class="form-horizontal" action="{{url('/productos/')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <span>Precio</span>
                                <input type="number" class="form-control" id="precio" name="precio" placeholder="$ 100000000" required>
                            </div>
                            <div class="form group">
                                <span>Categoria</span>
                            ...
                            <div class="form-group">
                                <span>Descuento</span>
                                <input type="number" class="form-control" id="descuento" name="descuento" placeholder="descuento %" required>
                            </div>
                            <div class="mb-3">
                                <span>Imagen</span>
