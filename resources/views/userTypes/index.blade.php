    ...
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <span class="main-content-title mg-b-0 mg-b-lg-1">Tipos de Usuario()</span>
            </div>
        </div>
        <!-- /breadcrumb -->
        <div class="row">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="tx-18 mb-4">
                            <a name="añadirTipo" id="añadirTipo" class="btn btn-primary" href="{{ url ('/user_types/create') }}" role="button">Añadir Tipo</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            @foreach($userTypes as $userType)
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <a href="{{url('/user_types/'.$userType->id)}}">
                            <div class="card-body">
